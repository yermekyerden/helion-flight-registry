...
const acceptedImageMimeTypes =
  flightApplicationFormLimits.image.acceptedMimeTypes.join(',');
    ...
    >
      ...
      >
        {(fieldProps) => (
          <TextInput
            autoComplete="name"
            maxLength={flightApplicationFormLimits.name.maxLength}
      ...
      >
        {(fieldProps) => (
          <NumberInput
            autoComplete="off"
            max={flightApplicationFormLimits.age.max}
            min={flightApplicationFormLimits.age.min}
            name={fieldNames.age}
