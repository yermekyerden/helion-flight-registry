...
export const flightApplicationFormContent = {
  ...
  fields: {
    ...
    pilotPhoto: {
      label: 'Pilot photo',
      hint: `PNG or JPEG image. Maximum file size: ${flightApplicationFormLimits.image.maxSizeInMegabytes} MB.`,
    },
    originSector: {
      label: 'Origin sector',
    },
  ...
  passphraseIntegrity: {
    ...
    requirements: {
      minimumLength: `At least ${flightApplicationFormLimits.password.minLength} characters`,
